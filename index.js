...
let drivers=['john','peter','mike','james','job']
...
//Declare a variable with const that is assigned an anonymous function. The assigned function 
...
//createFareMultiplier() — This is a higher-order function that takes in one argument,
 ...
 function createFareMultiplier(fprice){

   return function multiply()
   {
    const fare1= fprice*4
    return fare1
   }
}
...
// an array of drivers and either the returnFirstTwoDrivers() or returnLastTwoDrivers() function. Based on these two arguments, 
